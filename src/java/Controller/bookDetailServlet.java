...
public class bookDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Book bookDetail = bd.getBookDetail(bookId);
        CategoryDAO cd = new CategoryDAO();
        List<Category> listC;
        listC = cd.getAllCatgory();
        Category cate =cd.getCategoryById(bookId);
        
        List<Book> listN;
        listN = bd.getRandomBookByCategory(cate.getCategoryId());
        
        PublisherDAO pd = new PublisherDAO();
//        List<Publisher> listP;
//        listP = pd.getPublisher();
        Publisher pu = pd.getPublisherById(bookId);
        ...
        request.setAttribute("i", bookDetail);
